    ...
    <div class="row">
        <div class="col-8">
            <div class="row gap-4 justify-center">
                <div class="col-5 border   py-2 rounded"  v-for="post in posts" :key="post.created_at">
                    <div class="card">
                ...
                <div class="card-body border p-2 rounded-md">
                    <form method="POST" @submit.prevent="addItem()">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="" class="form-control" v-model="description" placeholder="Enter description" id="" cols="30" rows="10"></textarea>
                        </div>
                        <div class="form-group">
...
const { addItem, getPosts } = postStore();
